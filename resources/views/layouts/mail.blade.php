...
<table lang="en" bgcolor="#e6e6e6" cellpadding="16" cellspacing="0" role="presentation" width="100%">
    <tr>
        <td align="center" class="p-sm-0">
            <table class="container" bgcolor="#FFFFFF" cellpadding="0" cellspacing="0" role="presentation" width="600">
                <tr>
                    <td align="left">
                        {{--flexiPIM Logo--}}
                        <table bgcolor="#fafafa" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                            <tr>
                                <td>
                        ...
                        {{--Footer Divider--}}
                        <table bgcolor="#000" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                            <tr>
                        ...
                        {{--Footer Social Links--}}
                        @include('../mail/content/social-links')
                    </td>
                </tr>
            </table>
        </td>
